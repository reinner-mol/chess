(function () {
    ...
    window.onload = () => {
        const el = document.querySelector('#daily-puzzle'), board = el.querySelector('.mini-board'), [fen, orientation, lm] = board.getAttribute('data-state').split(',');
        ...
        Chessground(board.firstChild, {
            ...
            viewOnly: true,
            fen: fen,
            lastMove: lm ? [lm[0] + lm[1], lm[2] + lm[3]] : undefined,
