var LichessFlatpickr = (function () {
    ...
    lichess.load.then(() => {
        $('.flatpickr').each(function () {
            ...
            flatpickr(this, Object.assign({ minDate: 'today', maxDate: new Date(Date.now() + 1000 * 3600 * 24 * 31 * 3), monthSelectorType: 'static', disableMobile: true }, config));
        });
    });
